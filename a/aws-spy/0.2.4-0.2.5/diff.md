# Comparing `tmp/aws_spy-0.2.4.tar.gz` & `tmp/aws_spy-0.2.5.tar.gz`
...
### Comparing `aws_spy-0.2.4/tests/unit/test_responses.py` & `aws_spy-0.2.5/tests/unit/test_responses.py`
