# Comparing `tmp/esse-2023.7.11.post1.tar.gz` & `tmp/esse-2023.7.14.post0.tar.gz`
...
### Comparing `esse-2023.7.11.post1/.github/workflows/cicd.yml` & `esse-2023.7.14.post0/.github/workflows/cicd.yml`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/.gitignore` & `esse-2023.7.14.post0/.gitignore`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/LICENSE.md` & `esse-2023.7.14.post0/LICENSE.md`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/PKG-INFO` & `esse-2023.7.14.post0/PKG-INFO`
...
### Comparing `esse-2023.7.11.post1/README.md` & `esse-2023.7.14.post0/README.md`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/job/compute.json` & `esse-2023.7.14.post0/example/job/compute.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/job.json` & `esse-2023.7.14.post0/example/job.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/material.json` & `esse-2023.7.14.post0/example/material.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/methods_directory/pseudopotential/file.json` & `esse-2023.7.14.post0/example/methods_directory/pseudopotential/file.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/methods_directory/regression.json` & `esse-2023.7.14.post0/example/methods_directory/regression.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/models_directory/pb/qm/abin/configuration_interaction.json` & `esse-2023.7.14.post0/example/models_directory/pb/qm/abin/configuration_interaction.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/models_directory/pb/qm/dft/ksdft/double_hybrid/functional.json` & `esse-2023.7.14.post0/example/models_directory/pb/qm/dft/ksdft/double_hybrid/functional.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/models_directory/pb/qm/dft/ksdft/double_hybrid/range_separated_functional.json` & `esse-2023.7.14.post0/example/models_directory/pb/qm/dft/ksdft/double_hybrid/range_separated_functional.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/models_directory/pb/qm/dft/ksdft/hybrid/functional.json` & `esse-2023.7.14.post0/example/models_directory/pb/qm/dft/ksdft/hybrid/functional.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/models_directory/pb/qm/dft/ksdft/hybrid/range_separated_functional.json` & `esse-2023.7.14.post0/example/models_directory/pb/qm/dft/ksdft/hybrid/range_separated_functional.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/models_directory/pb/qm/dft/ksdft/lda.json` & `esse-2023.7.14.post0/example/models_directory/pb/qm/dft/ksdft/lda.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/models_directory/pb/qm/dft/ksdft.json` & `esse-2023.7.14.post0/example/models_directory/pb/qm/dft/ksdft.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/properties_directory/non-scalar/band_structure.json` & `esse-2023.7.14.post0/example/properties_directory/non-scalar/band_structure.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/properties_directory/non-scalar/density_of_states.json` & `esse-2023.7.14.post0/example/properties_directory/non-scalar/density_of_states.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/properties_directory/non-scalar/phonon_dispersions.json` & `esse-2023.7.14.post0/example/properties_directory/non-scalar/phonon_dispersions.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/properties_directory/non-scalar/phonon_dos.json` & `esse-2023.7.14.post0/example/properties_directory/non-scalar/phonon_dos.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/properties_directory/non-scalar/potential_profile.json` & `esse-2023.7.14.post0/example/properties_directory/non-scalar/potential_profile.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/properties_directory/non-scalar/reaction_energy_profile.json` & `esse-2023.7.14.post0/example/properties_directory/non-scalar/reaction_energy_profile.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/properties_directory/non-scalar/total_energy_contributions.json` & `esse-2023.7.14.post0/example/properties_directory/non-scalar/total_energy_contributions.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/properties_directory/structural/molecular_pattern.json` & `esse-2023.7.14.post0/example/properties_directory/structural/molecular_pattern.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/software_directory/ml/unit/execution/train.json` & `esse-2023.7.14.post0/example/software_directory/ml/unit/execution/train.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/software_directory/ml/unit/processing/data_transformation/scale_and_reduce.json` & `esse-2023.7.14.post0/example/software_directory/ml/unit/processing/data_transformation/scale_and_reduce.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/system/file_source.json` & `esse-2023.7.14.post0/example/system/file_source.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/workflow/unit/execution.json` & `esse-2023.7.14.post0/example/workflow/unit/execution.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/workflow/unit/io/api.json` & `esse-2023.7.14.post0/example/workflow/unit/io/api.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/workflow/unit/io.json` & `esse-2023.7.14.post0/example/workflow/unit/io.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/example/workflow.json` & `esse-2023.7.14.post0/example/workflow.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/manifest/dft_unit_functionals.yaml` & `esse-2023.7.14.post0/manifest/dft_unit_functionals.yaml`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/manifest/functional_lookup_table.yaml` & `esse-2023.7.14.post0/manifest/functional_lookup_table.yaml`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/manifest/models.yaml` & `esse-2023.7.14.post0/manifest/models.yaml`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/manifest/properties.yaml` & `esse-2023.7.14.post0/manifest/properties.yaml`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/package-lock.json` & `esse-2023.7.14.post0/package-lock.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/package.json` & `esse-2023.7.14.post0/package.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/run-tests.sh` & `esse-2023.7.14.post0/run-tests.sh`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/core/abstract/2d_plot.json` & `esse-2023.7.14.post0/schema/core/abstract/2d_plot.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/core/abstract/3d_vector_basis.json` & `esse-2023.7.14.post0/schema/core/abstract/3d_vector_basis.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/core/primitive/3d_lattice.json` & `esse-2023.7.14.post0/schema/core/primitive/3d_lattice.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/core/primitive/slugified_entry.json` & `esse-2023.7.14.post0/schema/core/primitive/slugified_entry.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/core/reference/exabyte.json` & `esse-2023.7.14.post0/schema/core/reference/exabyte.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/core/reference/experiment/condition.json` & `esse-2023.7.14.post0/schema/core/reference/experiment/condition.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/core/reference/experiment.json` & `esse-2023.7.14.post0/schema/core/reference/experiment.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/core/reference/literature.json` & `esse-2023.7.14.post0/schema/core/reference/literature.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/core/reference/modeling/exabyte.json` & `esse-2023.7.14.post0/schema/core/reference/modeling/exabyte.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/core/reusable/band_gap.json` & `esse-2023.7.14.post0/schema/core/reusable/band_gap.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/core/reusable/energy.json` & `esse-2023.7.14.post0/schema/core/reusable/energy.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/core/reusable/file_metadata.json` & `esse-2023.7.14.post0/schema/core/reusable/file_metadata.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/core/reusable/object_storage_container_data.json` & `esse-2023.7.14.post0/schema/core/reusable/object_storage_container_data.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/definitions/units.json` & `esse-2023.7.14.post0/schema/definitions/units.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/element.json` & `esse-2023.7.14.post0/schema/element.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/in_memory_entity/base.json` & `esse-2023.7.14.post0/schema/in_memory_entity/base.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/job/compute.json` & `esse-2023.7.14.post0/schema/job/compute.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/job.json` & `esse-2023.7.14.post0/schema/job.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/material.json` & `esse-2023.7.14.post0/schema/material.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/method.json` & `esse-2023.7.14.post0/schema/method.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/methods_directory/local-orbital.json` & `esse-2023.7.14.post0/schema/methods_directory/local-orbital.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/methods_directory/local_orbital/definitions/basis_sets.json` & `esse-2023.7.14.post0/schema/methods_directory/local_orbital/definitions/basis_sets.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/methods_directory/pseudopotential/dataset.json` & `esse-2023.7.14.post0/schema/methods_directory/pseudopotential/dataset.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/methods_directory/pseudopotential/file/energy_cutoff.json` & `esse-2023.7.14.post0/schema/methods_directory/pseudopotential/file/energy_cutoff.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/methods_directory/pseudopotential/file/radii.json` & `esse-2023.7.14.post0/schema/methods_directory/pseudopotential/file/radii.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/methods_directory/pseudopotential/file.json` & `esse-2023.7.14.post0/schema/methods_directory/pseudopotential/file.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/methods_directory/pseudopotential/precision.json` & `esse-2023.7.14.post0/schema/methods_directory/pseudopotential/precision.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/methods_directory/pseudopotential.json` & `esse-2023.7.14.post0/schema/methods_directory/pseudopotential.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/methods_directory/regression/dataset.json` & `esse-2023.7.14.post0/schema/methods_directory/regression/dataset.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/methods_directory/regression/kernel_ridge/data_per_property.json` & `esse-2023.7.14.post0/schema/methods_directory/regression/kernel_ridge/data_per_property.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/methods_directory/regression/linear/data_per_property.json` & `esse-2023.7.14.post0/schema/methods_directory/regression/linear/data_per_property.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/methods_directory/regression/precision_per_property.json` & `esse-2023.7.14.post0/schema/methods_directory/regression/precision_per_property.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/methods_directory/regression.json` & `esse-2023.7.14.post0/schema/methods_directory/regression.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/model.json` & `esse-2023.7.14.post0/schema/model.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/abin/configuration_interaction/modifiers.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/abin/configuration_interaction/modifiers.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/abin/configuration_interaction/tags.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/abin/configuration_interaction/tags.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/abin/configuration_interaction.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/abin/configuration_interaction.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/definitions.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/definitions.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/dft_unit_functionals.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/dft_unit_functionals.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/dft_unit_functionals_proto.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/dft_unit_functionals_proto.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/dispersion_model.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/dispersion_model.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/dispersion_models_directory/dft_d.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/dispersion_models_directory/dft_d.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/dispersion_models_directory/exchange_dipole.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/dispersion_models_directory/exchange_dipole.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/dispersion_models_directory/generalized/intra_abin.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/dispersion_models_directory/generalized/intra_abin.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/dispersion_models_directory/generalized/intra_empirical.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/dispersion_models_directory/generalized/intra_empirical.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/dispersion_models_directory/generalized/post_abin.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/dispersion_models_directory/generalized/post_abin.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/dispersion_models_directory/generalized/post_empirical.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/dispersion_models_directory/generalized/post_empirical.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/dispersion_models_directory/many_body_dispersion.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/dispersion_models_directory/many_body_dispersion.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/dispersion_models_directory/non_local_correlation.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/dispersion_models_directory/non_local_correlation.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/dispersion_models_directory/tkatchenko_scheffler.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/dispersion_models_directory/tkatchenko_scheffler.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/functional/component.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/functional/component.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/functional/components_directory/exact_exchange.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/functional/components_directory/exact_exchange.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/functional/components_directory/mp2_correlation.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/functional/components_directory/mp2_correlation.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/functional/components_directory/range_separated_exchange.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/functional/components_directory/range_separated_exchange.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/functional/definitions.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/functional/definitions.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/double_hybrid/functional.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/double_hybrid/functional.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/double_hybrid/modifiers.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/double_hybrid/modifiers.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/double_hybrid/range_separated_functional.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/double_hybrid/range_separated_functional.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/double_hybrid/tags.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/double_hybrid/tags.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/double_hybrid.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/double_hybrid.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/gga/modifiers.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/gga/modifiers.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/gga/tags.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/gga/tags.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/gga.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/gga.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/hybrid/functional.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/hybrid/functional.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/hybrid/modifiers.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/hybrid/modifiers.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/hybrid/range_separated_functional.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/hybrid/range_separated_functional.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/hybrid/tags.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/hybrid/tags.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/hybrid.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/hybrid.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/lda/modifiers.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/lda/modifiers.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/lda/tags.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/lda/tags.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/lda.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/lda.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/mgga/modifiers.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/mgga/modifiers.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/mgga/tags.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/mgga/tags.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/mgga.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/mgga.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/modifiers.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/modifiers.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft/tags.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft/tags.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft/ksdft.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft/ksdft.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/dft.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/dft.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/pb/qm/semp.json` & `esse-2023.7.14.post0/schema/models_directory/pb/qm/semp.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/st/det/ml.json` & `esse-2023.7.14.post0/schema/models_directory/st/det/ml.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/models_directory/unknown.json` & `esse-2023.7.14.post0/schema/models_directory/unknown.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/new_model.json` & `esse-2023.7.14.post0/schema/new_model.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/project.json` & `esse-2023.7.14.post0/schema/project.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/derived_properties.json` & `esse-2023.7.14.post0/schema/properties_directory/derived_properties.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/elemental/ionization_potential.json` & `esse-2023.7.14.post0/schema/properties_directory/elemental/ionization_potential.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/non-scalar/average_potential_profile.json` & `esse-2023.7.14.post0/schema/properties_directory/non-scalar/average_potential_profile.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/non-scalar/band_gaps.json` & `esse-2023.7.14.post0/schema/properties_directory/non-scalar/band_gaps.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/non-scalar/band_structure.json` & `esse-2023.7.14.post0/schema/properties_directory/non-scalar/band_structure.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/non-scalar/charge_density_profile.json` & `esse-2023.7.14.post0/schema/properties_directory/non-scalar/charge_density_profile.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/non-scalar/density_of_states.json` & `esse-2023.7.14.post0/schema/properties_directory/non-scalar/density_of_states.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/non-scalar/file_content.json` & `esse-2023.7.14.post0/schema/properties_directory/non-scalar/file_content.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/non-scalar/phonon_dispersions.json` & `esse-2023.7.14.post0/schema/properties_directory/non-scalar/phonon_dispersions.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/non-scalar/phonon_dos.json` & `esse-2023.7.14.post0/schema/properties_directory/non-scalar/phonon_dos.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/non-scalar/potential_profile.json` & `esse-2023.7.14.post0/schema/properties_directory/non-scalar/potential_profile.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/non-scalar/reaction_energy_profile.json` & `esse-2023.7.14.post0/schema/properties_directory/non-scalar/reaction_energy_profile.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/non-scalar/total_energy_contributions.json` & `esse-2023.7.14.post0/schema/properties_directory/non-scalar/total_energy_contributions.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/non-scalar/vibrational_spectrum.json` & `esse-2023.7.14.post0/schema/properties_directory/non-scalar/vibrational_spectrum.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/structural/atomic_forces.json` & `esse-2023.7.14.post0/schema/properties_directory/structural/atomic_forces.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/structural/basis/atomic_coordinates.json` & `esse-2023.7.14.post0/schema/properties_directory/structural/basis/atomic_coordinates.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/structural/basis/atomic_element.json` & `esse-2023.7.14.post0/schema/properties_directory/structural/basis/atomic_element.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/structural/basis/bonds.json` & `esse-2023.7.14.post0/schema/properties_directory/structural/basis/bonds.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/structural/basis.json` & `esse-2023.7.14.post0/schema/properties_directory/structural/basis.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/structural/elemental_ratio.json` & `esse-2023.7.14.post0/schema/properties_directory/structural/elemental_ratio.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/structural/lattice/lattice_bravais.json` & `esse-2023.7.14.post0/schema/properties_directory/structural/lattice/lattice_bravais.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/structural/lattice/lattice_vectors.json` & `esse-2023.7.14.post0/schema/properties_directory/structural/lattice/lattice_vectors.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/structural/lattice.json` & `esse-2023.7.14.post0/schema/properties_directory/structural/lattice.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/structural/magnetic_moments.json` & `esse-2023.7.14.post0/schema/properties_directory/structural/magnetic_moments.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/structural/p-norm.json` & `esse-2023.7.14.post0/schema/properties_directory/structural/p-norm.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/structural/patterns/functional_group.json` & `esse-2023.7.14.post0/schema/properties_directory/structural/patterns/functional_group.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/structural/patterns/ring.json` & `esse-2023.7.14.post0/schema/properties_directory/structural/patterns/ring.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/structural/patterns/special_bond.json` & `esse-2023.7.14.post0/schema/properties_directory/structural/patterns/special_bond.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/structural/symmetry.json` & `esse-2023.7.14.post0/schema/properties_directory/structural/symmetry.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/workflow/convergence/electronic.json` & `esse-2023.7.14.post0/schema/properties_directory/workflow/convergence/electronic.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/workflow/convergence/ionic.json` & `esse-2023.7.14.post0/schema/properties_directory/workflow/convergence/ionic.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/properties_directory/workflow/convergence/kpoint.json` & `esse-2023.7.14.post0/schema/properties_directory/workflow/convergence/kpoint.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/property/raw.json` & `esse-2023.7.14.post0/schema/property/raw.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/property/refined.json` & `esse-2023.7.14.post0/schema/property/refined.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/property/source.json` & `esse-2023.7.14.post0/schema/property/source.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/software/application.json` & `esse-2023.7.14.post0/schema/software/application.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/software/executable.json` & `esse-2023.7.14.post0/schema/software/executable.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/software/flavor.json` & `esse-2023.7.14.post0/schema/software/flavor.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/software/template.json` & `esse-2023.7.14.post0/schema/software/template.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/software_directory/ml/exabyteml.json` & `esse-2023.7.14.post0/schema/software_directory/ml/exabyteml.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/software_directory/ml/unit/execution/evaluate/cross-validate.json` & `esse-2023.7.14.post0/schema/software_directory/ml/unit/execution/evaluate/cross-validate.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/software_directory/ml/unit/execution/initialize.json` & `esse-2023.7.14.post0/schema/software_directory/ml/unit/execution/initialize.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/software_directory/ml/unit/execution/train.json` & `esse-2023.7.14.post0/schema/software_directory/ml/unit/execution/train.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/software_directory/ml/unit/processing/data_transformation/manipulation.json` & `esse-2023.7.14.post0/schema/software_directory/ml/unit/processing/data_transformation/manipulation.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/software_directory/ml/unit/processing/data_transformation/scale_and_reduce.json` & `esse-2023.7.14.post0/schema/software_directory/ml/unit/processing/data_transformation/scale_and_reduce.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/software_directory/ml/unit/processing/feature_selection/filter_based.json` & `esse-2023.7.14.post0/schema/software_directory/ml/unit/processing/feature_selection/filter_based.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/software_directory/modeling/espresso/arguments.json` & `esse-2023.7.14.post0/schema/software_directory/modeling/espresso/arguments.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/software_directory/modeling/espresso.json` & `esse-2023.7.14.post0/schema/software_directory/modeling/espresso.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/software_directory/modeling/nwchem.json` & `esse-2023.7.14.post0/schema/software_directory/modeling/nwchem.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/software_directory/modeling/vasp.json` & `esse-2023.7.14.post0/schema/software_directory/modeling/vasp.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/software_directory/scripting/jupyter-lab.json` & `esse-2023.7.14.post0/schema/software_directory/scripting/jupyter-lab.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/software_directory/scripting/python.json` & `esse-2023.7.14.post0/schema/software_directory/scripting/python.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/software_directory/scripting/shell.json` & `esse-2023.7.14.post0/schema/software_directory/scripting/shell.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/system/database_source.json` & `esse-2023.7.14.post0/schema/system/database_source.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/system/file_source.json` & `esse-2023.7.14.post0/schema/system/file_source.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/system/history.json` & `esse-2023.7.14.post0/schema/system/history.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/system/in_set.json` & `esse-2023.7.14.post0/schema/system/in_set.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/system/job_extended.json` & `esse-2023.7.14.post0/schema/system/job_extended.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/system/message.json` & `esse-2023.7.14.post0/schema/system/message.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/system/status.json` & `esse-2023.7.14.post0/schema/system/status.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/system/timestampable.json` & `esse-2023.7.14.post0/schema/system/timestampable.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/base_flow.json` & `esse-2023.7.14.post0/schema/workflow/base_flow.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/new_subworkflow.json` & `esse-2023.7.14.post0/schema/workflow/new_subworkflow.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/subworkflow.json` & `esse-2023.7.14.post0/schema/workflow/subworkflow.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/unit/assertion.json` & `esse-2023.7.14.post0/schema/workflow/unit/assertion.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/unit/assignment.json` & `esse-2023.7.14.post0/schema/workflow/unit/assignment.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/unit/condition.json` & `esse-2023.7.14.post0/schema/workflow/unit/condition.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/unit/execution.json` & `esse-2023.7.14.post0/schema/workflow/unit/execution.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/unit/input/_input.json` & `esse-2023.7.14.post0/schema/workflow/unit/input/_input.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/unit/input/_inputItem.json` & `esse-2023.7.14.post0/schema/workflow/unit/input/_inputItem.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/unit/input/_inputItemId.json` & `esse-2023.7.14.post0/schema/workflow/unit/input/_inputItemId.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/unit/input/_inputItemScope.json` & `esse-2023.7.14.post0/schema/workflow/unit/input/_inputItemScope.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/unit/io/api.json` & `esse-2023.7.14.post0/schema/workflow/unit/io/api.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/unit/io/db.json` & `esse-2023.7.14.post0/schema/workflow/unit/io/db.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/unit/io/object_storage.json` & `esse-2023.7.14.post0/schema/workflow/unit/io/object_storage.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/unit/io.json` & `esse-2023.7.14.post0/schema/workflow/unit/io.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/unit/map.json` & `esse-2023.7.14.post0/schema/workflow/unit/map.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/unit/processing.json` & `esse-2023.7.14.post0/schema/workflow/unit/processing.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/unit/reduce.json` & `esse-2023.7.14.post0/schema/workflow/unit/reduce.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/unit/runtime/runtime_items.json` & `esse-2023.7.14.post0/schema/workflow/unit/runtime/runtime_items.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow/unit.json` & `esse-2023.7.14.post0/schema/workflow/unit.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/schema/workflow.json` & `esse-2023.7.14.post0/schema/workflow.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/setup.py` & `esse-2023.7.14.post0/setup.py`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/js/esse/index.js` & `esse-2023.7.14.post0/src/js/esse/index.js`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/js/esse/tests/validate.js` & `esse-2023.7.14.post0/src/js/esse/tests/validate.js`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/js/esse/utils.js` & `esse-2023.7.14.post0/src/js/esse/utils.js`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/js/json_include/index.js` & `esse-2023.7.14.post0/src/js/json_include/index.js`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/js/scripts/setSchemaIds.mjs` & `esse-2023.7.14.post0/src/js/scripts/setSchemaIds.mjs`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/__init__.py` & `esse-2023.7.14.post0/src/py/esse/__init__.py`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/job/compute.json` & `esse-2023.7.14.post0/src/py/esse/data/example/job/compute.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/job.json` & `esse-2023.7.14.post0/src/py/esse/data/example/job.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/material.json` & `esse-2023.7.14.post0/src/py/esse/data/example/material.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/methods_directory/pseudopotential/file.json` & `esse-2023.7.14.post0/src/py/esse/data/example/methods_directory/pseudopotential/file.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/methods_directory/regression.json` & `esse-2023.7.14.post0/src/py/esse/data/example/methods_directory/regression.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/models_directory/pb/qm/abin/configuration_interaction.json` & `esse-2023.7.14.post0/src/py/esse/data/example/models_directory/pb/qm/abin/configuration_interaction.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/models_directory/pb/qm/dft/ksdft/double_hybrid/functional.json` & `esse-2023.7.14.post0/src/py/esse/data/example/models_directory/pb/qm/dft/ksdft/double_hybrid/functional.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/models_directory/pb/qm/dft/ksdft/double_hybrid/range_separated_functional.json` & `esse-2023.7.14.post0/src/py/esse/data/example/models_directory/pb/qm/dft/ksdft/double_hybrid/range_separated_functional.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/models_directory/pb/qm/dft/ksdft/hybrid/functional.json` & `esse-2023.7.14.post0/src/py/esse/data/example/models_directory/pb/qm/dft/ksdft/hybrid/functional.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/models_directory/pb/qm/dft/ksdft/hybrid/range_separated_functional.json` & `esse-2023.7.14.post0/src/py/esse/data/example/models_directory/pb/qm/dft/ksdft/hybrid/range_separated_functional.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/models_directory/pb/qm/dft/ksdft/lda.json` & `esse-2023.7.14.post0/src/py/esse/data/example/models_directory/pb/qm/dft/ksdft/lda.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/models_directory/pb/qm/dft/ksdft.json` & `esse-2023.7.14.post0/src/py/esse/data/example/models_directory/pb/qm/dft/ksdft.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/properties_directory/non-scalar/band_structure.json` & `esse-2023.7.14.post0/src/py/esse/data/example/properties_directory/non-scalar/band_structure.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/properties_directory/non-scalar/density_of_states.json` & `esse-2023.7.14.post0/src/py/esse/data/example/properties_directory/non-scalar/density_of_states.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/properties_directory/non-scalar/phonon_dispersions.json` & `esse-2023.7.14.post0/src/py/esse/data/example/properties_directory/non-scalar/phonon_dispersions.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/properties_directory/non-scalar/phonon_dos.json` & `esse-2023.7.14.post0/src/py/esse/data/example/properties_directory/non-scalar/phonon_dos.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/properties_directory/non-scalar/potential_profile.json` & `esse-2023.7.14.post0/src/py/esse/data/example/properties_directory/non-scalar/potential_profile.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/properties_directory/non-scalar/reaction_energy_profile.json` & `esse-2023.7.14.post0/src/py/esse/data/example/properties_directory/non-scalar/reaction_energy_profile.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/properties_directory/non-scalar/total_energy_contributions.json` & `esse-2023.7.14.post0/src/py/esse/data/example/properties_directory/non-scalar/total_energy_contributions.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/properties_directory/structural/molecular_pattern.json` & `esse-2023.7.14.post0/src/py/esse/data/example/properties_directory/structural/molecular_pattern.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/software_directory/ml/unit/execution/train.json` & `esse-2023.7.14.post0/src/py/esse/data/example/software_directory/ml/unit/execution/train.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/software_directory/ml/unit/processing/data_transformation/scale_and_reduce.json` & `esse-2023.7.14.post0/src/py/esse/data/example/software_directory/ml/unit/processing/data_transformation/scale_and_reduce.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/system/file_source.json` & `esse-2023.7.14.post0/src/py/esse/data/example/system/file_source.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/workflow/unit/execution.json` & `esse-2023.7.14.post0/src/py/esse/data/example/workflow/unit/execution.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/workflow/unit/io/api.json` & `esse-2023.7.14.post0/src/py/esse/data/example/workflow/unit/io/api.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/workflow/unit/io.json` & `esse-2023.7.14.post0/src/py/esse/data/example/workflow/unit/io.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/example/workflow.json` & `esse-2023.7.14.post0/src/py/esse/data/example/workflow.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/manifest/dft_unit_functionals.yaml` & `esse-2023.7.14.post0/src/py/esse/data/manifest/dft_unit_functionals.yaml`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/manifest/functional_lookup_table.yaml` & `esse-2023.7.14.post0/src/py/esse/data/manifest/functional_lookup_table.yaml`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/manifest/models.yaml` & `esse-2023.7.14.post0/src/py/esse/data/manifest/models.yaml`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/manifest/properties.yaml` & `esse-2023.7.14.post0/src/py/esse/data/manifest/properties.yaml`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/core/abstract/2d_plot.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/core/abstract/2d_plot.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/core/abstract/3d_vector_basis.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/core/abstract/3d_vector_basis.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/core/primitive/3d_lattice.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/core/primitive/3d_lattice.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/core/primitive/slugified_entry.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/core/primitive/slugified_entry.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/core/reference/exabyte.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/core/reference/exabyte.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/core/reference/experiment/condition.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/core/reference/experiment/condition.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/core/reference/experiment.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/core/reference/experiment.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/core/reference/literature.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/core/reference/literature.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/core/reference/modeling/exabyte.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/core/reference/modeling/exabyte.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/core/reusable/band_gap.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/core/reusable/band_gap.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/core/reusable/energy.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/core/reusable/energy.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/core/reusable/file_metadata.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/core/reusable/file_metadata.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/core/reusable/object_storage_container_data.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/core/reusable/object_storage_container_data.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/definitions/units.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/definitions/units.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/element.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/element.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/in_memory_entity/base.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/in_memory_entity/base.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/job/compute.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/job/compute.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/job.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/job.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/material.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/material.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/method.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/method.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/methods_directory/local-orbital.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/methods_directory/local-orbital.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/methods_directory/local_orbital/definitions/basis_sets.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/methods_directory/local_orbital/definitions/basis_sets.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/methods_directory/pseudopotential/dataset.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/methods_directory/pseudopotential/dataset.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/methods_directory/pseudopotential/file/energy_cutoff.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/methods_directory/pseudopotential/file/energy_cutoff.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/methods_directory/pseudopotential/file/radii.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/methods_directory/pseudopotential/file/radii.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/methods_directory/pseudopotential/file.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/methods_directory/pseudopotential/file.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/methods_directory/pseudopotential/precision.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/methods_directory/pseudopotential/precision.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/methods_directory/pseudopotential.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/methods_directory/pseudopotential.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/methods_directory/regression/dataset.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/methods_directory/regression/dataset.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/methods_directory/regression/kernel_ridge/data_per_property.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/methods_directory/regression/kernel_ridge/data_per_property.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/methods_directory/regression/linear/data_per_property.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/methods_directory/regression/linear/data_per_property.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/methods_directory/regression/precision_per_property.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/methods_directory/regression/precision_per_property.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/methods_directory/regression.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/methods_directory/regression.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/model.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/model.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/abin/configuration_interaction/modifiers.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/abin/configuration_interaction/modifiers.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/abin/configuration_interaction/tags.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/abin/configuration_interaction/tags.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/abin/configuration_interaction.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/abin/configuration_interaction.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/definitions.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/definitions.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/dft_unit_functionals.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/dft_unit_functionals.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/dft_unit_functionals_proto.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/dft_unit_functionals_proto.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_model.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_model.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_models_directory/dft_d.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_models_directory/dft_d.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_models_directory/exchange_dipole.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_models_directory/exchange_dipole.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_models_directory/generalized/intra_abin.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_models_directory/generalized/intra_abin.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_models_directory/generalized/intra_empirical.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_models_directory/generalized/intra_empirical.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_models_directory/generalized/post_abin.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_models_directory/generalized/post_abin.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_models_directory/generalized/post_empirical.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_models_directory/generalized/post_empirical.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_models_directory/many_body_dispersion.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_models_directory/many_body_dispersion.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_models_directory/non_local_correlation.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_models_directory/non_local_correlation.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_models_directory/tkatchenko_scheffler.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/dispersion_models_directory/tkatchenko_scheffler.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/functional/component.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/functional/component.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/functional/components_directory/exact_exchange.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/functional/components_directory/exact_exchange.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/functional/components_directory/mp2_correlation.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/functional/components_directory/mp2_correlation.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/functional/components_directory/range_separated_exchange.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/functional/components_directory/range_separated_exchange.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/functional/definitions.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/functional/definitions.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/double_hybrid/functional.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/double_hybrid/functional.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/double_hybrid/modifiers.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/double_hybrid/modifiers.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/double_hybrid/range_separated_functional.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/double_hybrid/range_separated_functional.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/double_hybrid/tags.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/double_hybrid/tags.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/double_hybrid.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/double_hybrid.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/gga/modifiers.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/gga/modifiers.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/gga/tags.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/gga/tags.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/gga.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/gga.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/hybrid/functional.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/hybrid/functional.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/hybrid/modifiers.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/hybrid/modifiers.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/hybrid/range_separated_functional.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/hybrid/range_separated_functional.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/hybrid/tags.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/hybrid/tags.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/hybrid.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/hybrid.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/lda/modifiers.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/lda/modifiers.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/lda/tags.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/lda/tags.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/lda.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/lda.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/mgga/modifiers.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/mgga/modifiers.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/mgga/tags.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/mgga/tags.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/mgga.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/mgga.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/modifiers.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/modifiers.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/tags.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft/tags.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft/ksdft.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/dft.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/dft.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/pb/qm/semp.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/pb/qm/semp.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/st/det/ml.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/st/det/ml.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/models_directory/unknown.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/models_directory/unknown.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/new_model.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/new_model.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/project.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/project.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/derived_properties.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/derived_properties.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/elemental/ionization_potential.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/elemental/ionization_potential.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/non-scalar/average_potential_profile.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/non-scalar/average_potential_profile.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/non-scalar/band_gaps.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/non-scalar/band_gaps.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/non-scalar/band_structure.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/non-scalar/band_structure.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/non-scalar/charge_density_profile.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/non-scalar/charge_density_profile.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/non-scalar/density_of_states.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/non-scalar/density_of_states.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/non-scalar/file_content.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/non-scalar/file_content.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/non-scalar/phonon_dispersions.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/non-scalar/phonon_dispersions.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/non-scalar/phonon_dos.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/non-scalar/phonon_dos.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/non-scalar/potential_profile.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/non-scalar/potential_profile.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/non-scalar/reaction_energy_profile.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/non-scalar/reaction_energy_profile.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/non-scalar/total_energy_contributions.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/non-scalar/total_energy_contributions.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/non-scalar/vibrational_spectrum.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/non-scalar/vibrational_spectrum.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/structural/atomic_forces.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/structural/atomic_forces.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/structural/basis/atomic_coordinates.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/structural/basis/atomic_coordinates.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/structural/basis/atomic_element.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/structural/basis/atomic_element.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/structural/basis/bonds.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/structural/basis/bonds.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/structural/basis.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/structural/basis.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/structural/elemental_ratio.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/structural/elemental_ratio.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/structural/lattice/lattice_bravais.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/structural/lattice/lattice_bravais.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/structural/lattice/lattice_vectors.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/structural/lattice/lattice_vectors.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/structural/lattice.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/structural/lattice.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/structural/magnetic_moments.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/structural/magnetic_moments.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/structural/p-norm.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/structural/p-norm.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/structural/patterns/functional_group.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/structural/patterns/functional_group.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/structural/patterns/ring.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/structural/patterns/ring.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/structural/patterns/special_bond.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/structural/patterns/special_bond.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/structural/symmetry.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/structural/symmetry.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/workflow/convergence/electronic.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/workflow/convergence/electronic.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/workflow/convergence/ionic.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/workflow/convergence/ionic.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/properties_directory/workflow/convergence/kpoint.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/properties_directory/workflow/convergence/kpoint.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/property/raw.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/property/raw.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/property/refined.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/property/refined.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/property/source.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/property/source.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/software/application.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/software/application.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/software/executable.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/software/executable.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/software/flavor.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/software/flavor.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/software/template.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/software/template.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/software_directory/ml/exabyteml.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/software_directory/ml/exabyteml.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/software_directory/ml/unit/execution/evaluate/cross-validate.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/software_directory/ml/unit/execution/evaluate/cross-validate.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/software_directory/ml/unit/execution/initialize.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/software_directory/ml/unit/execution/initialize.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/software_directory/ml/unit/execution/train.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/software_directory/ml/unit/execution/train.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/software_directory/ml/unit/processing/data_transformation/manipulation.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/software_directory/ml/unit/processing/data_transformation/manipulation.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/software_directory/ml/unit/processing/data_transformation/scale_and_reduce.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/software_directory/ml/unit/processing/data_transformation/scale_and_reduce.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/software_directory/ml/unit/processing/feature_selection/filter_based.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/software_directory/ml/unit/processing/feature_selection/filter_based.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/software_directory/modeling/espresso/arguments.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/software_directory/modeling/espresso/arguments.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/software_directory/modeling/espresso.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/software_directory/modeling/espresso.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/software_directory/modeling/nwchem.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/software_directory/modeling/nwchem.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/software_directory/modeling/vasp.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/software_directory/modeling/vasp.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/software_directory/scripting/jupyter-lab.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/software_directory/scripting/jupyter-lab.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/software_directory/scripting/python.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/software_directory/scripting/python.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/software_directory/scripting/shell.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/software_directory/scripting/shell.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/system/database_source.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/system/database_source.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/system/file_source.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/system/file_source.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/system/history.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/system/history.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/system/in_set.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/system/in_set.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/system/job_extended.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/system/job_extended.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/system/message.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/system/message.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/system/status.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/system/status.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/system/timestampable.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/system/timestampable.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/base_flow.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/base_flow.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/new_subworkflow.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/new_subworkflow.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/subworkflow.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/subworkflow.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/unit/assertion.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/unit/assertion.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/unit/assignment.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/unit/assignment.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/unit/condition.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/unit/condition.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/unit/execution.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/unit/execution.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/unit/input/_input.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/unit/input/_input.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/unit/input/_inputItem.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/unit/input/_inputItem.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/unit/input/_inputItemId.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/unit/input/_inputItemId.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/unit/input/_inputItemScope.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/unit/input/_inputItemScope.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/unit/io/api.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/unit/io/api.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/unit/io/db.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/unit/io/db.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/unit/io/object_storage.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/unit/io/object_storage.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/unit/io.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/unit/io.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/unit/map.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/unit/map.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/unit/processing.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/unit/processing.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/unit/reduce.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/unit/reduce.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/unit/runtime/runtime_items.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/unit/runtime/runtime_items.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow/unit.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow/unit.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/data/schema/workflow.json` & `esse-2023.7.14.post0/src/py/esse/data/schema/workflow.json`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/functionals.py` & `esse-2023.7.14.post0/src/py/esse/functionals.py`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/tests/validate.py` & `esse-2023.7.14.post0/src/py/esse/tests/validate.py`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse/utils.py` & `esse-2023.7.14.post0/src/py/esse/utils.py`

 * *Files identical despite different names*

### Comparing `esse-2023.7.11.post1/src/py/esse.egg-info/PKG-INFO` & `esse-2023.7.14.post0/src/py/esse.egg-info/PKG-INFO`
...
### Comparing `esse-2023.7.11.post1/src/py/esse.egg-info/SOURCES.txt` & `esse-2023.7.14.post0/src/py/esse.egg-info/SOURCES.txt`
...
+src/py/esse/data/schema/property/meta.json
