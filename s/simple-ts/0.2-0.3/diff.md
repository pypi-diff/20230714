# Comparing `tmp/simple_ts-0.2.tar.gz` & `tmp/simple_ts-0.3.tar.gz`
...
## Comparing `simple_ts-0.2.tar` & `simple_ts-0.3.tar`
...
### Comparing `simple_ts-0.2/README.txt` & `simple_ts-0.3/README.txt`

 * *Files identical despite different names*

### Comparing `simple_ts-0.2/simplets/simplets.py` & `simple_ts-0.3/simplets/simplets.py`
