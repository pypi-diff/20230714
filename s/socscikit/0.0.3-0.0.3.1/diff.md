# Comparing `tmp/socscikit-0.0.3.tar.gz` & `tmp/socscikit-0.0.3.1.tar.gz`
...
## Comparing `socscikit-0.0.3.tar` & `socscikit-0.0.3.1.tar`
...
### Comparing `socscikit-0.0.3/LICENSE.txt` & `socscikit-0.0.3.1/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `socscikit-0.0.3/setup.py` & `socscikit-0.0.3.1/setup.py`
...
### Comparing `socscikit-0.0.3/socscikit/socialmedia.py` & `socscikit-0.0.3.1/socscikit/socialmedia.py`
