# Comparing `tmp/scPANTHEON-0.3.5.tar.gz` & `tmp/scPANTHEON-0.3.6.tar.gz`
...
## Comparing `scPANTHEON-0.3.5.tar` & `scPANTHEON-0.3.6.tar`
...
### Comparing `scPANTHEON-0.3.5/scpantheon/main.py` & `scPANTHEON-0.3.6/scpantheon/main.py`

 * *Files identical despite different names*

### Comparing `scPANTHEON-0.3.5/scpantheon/source.py` & `scPANTHEON-0.3.6/scpantheon/source.py`

 * *Files identical despite different names*

### Comparing `scPANTHEON-0.3.5/setup.py` & `scPANTHEON-0.3.6/setup.py`
