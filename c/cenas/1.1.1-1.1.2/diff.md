# Comparing `tmp/cenas-1.1.1.tar.gz` & `tmp/cenas-1.1.2.tar.gz`
...
## Comparing `cenas-1.1.1.tar` & `cenas-1.1.2.tar`
...
### Comparing `cenas-1.1.1/cenas1/settings.py` & `cenas-1.1.2/cenas1/settings.py`

 * *Files identical despite different names*

### Comparing `cenas-1.1.1/cenas1/urls.py` & `cenas-1.1.2/cenas1/urls.py`
