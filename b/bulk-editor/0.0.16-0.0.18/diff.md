# Comparing `tmp/bulk_editor-0.0.16.tar.gz` & `tmp/bulk_editor-0.0.18.tar.gz`
...
## Comparing `bulk_editor-0.0.16.tar` & `bulk_editor-0.0.18.tar`
...
### Comparing `bulk_editor-0.0.16/PKG-INFO` & `bulk_editor-0.0.18/PKG-INFO`
...
### Comparing `bulk_editor-0.0.16/bulkeditor/__init__.py` & `bulk_editor-0.0.18/bulkeditor/__init__.py`
...
### Comparing `bulk_editor-0.0.16/bulk_editor.egg-info/PKG-INFO` & `bulk_editor-0.0.18/bulk_editor.egg-info/PKG-INFO`
...
### Comparing `bulk_editor-0.0.16/README.md` & `bulk_editor-0.0.18/README.md`

 * *Files identical despite different names*

### Comparing `bulk_editor-0.0.16/setup.py` & `bulk_editor-0.0.18/setup.py`
