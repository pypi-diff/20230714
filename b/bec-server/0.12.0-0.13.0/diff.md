# Comparing `tmp/bec-server-0.12.0.tar.gz` & `tmp/bec-server-0.13.0.tar.gz`
...
## Comparing `bec-server-0.12.0.tar` & `bec-server-0.13.0.tar`
...
### Comparing `bec-server-0.12.0/bec_server/launch.py` & `bec-server-0.13.0/bec_server/launch.py`

 * *Files identical despite different names*

### Comparing `bec-server-0.12.0/bec_server/service_handler.py` & `bec-server-0.13.0/bec_server/service_handler.py`

 * *Files identical despite different names*

### Comparing `bec-server-0.12.0/bec_server/tmux_launch.py` & `bec-server-0.13.0/bec_server/tmux_launch.py`

 * *Files identical despite different names*

### Comparing `bec-server-0.12.0/setup.py` & `bec-server-0.13.0/setup.py`
