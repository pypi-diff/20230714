# Comparing `tmp/orso-0.0.80.tar.gz` & `tmp/orso-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "orso-0.0.80.tar", last modified: Fri Jul 14 21:15:26 2023, max compression
+gzip compressed data, was "orso-0.0.9.tar", last modified: Sun Mar 12 02:47:11 2023, max compression
```

## Comparing `orso-0.0.80.tar` & `orso-0.0.9.tar`

### file list

```diff
@@ -1,62 +1,26 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-14 21:15:26.834981 orso-0.0.80/
--rw-r--r--   0 runner    (1001) docker     (123)    11346 2023-07-14 21:15:05.000000 orso-0.0.80/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)     2007 2023-07-14 21:15:26.834981 orso-0.0.80/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     1778 2023-07-14 21:15:05.000000 orso-0.0.80/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-14 21:15:26.826980 orso-0.0.80/orso/
--rw-r--r--   0 runner    (1001) docker     (123)      139 2023-07-14 21:15:05.000000 orso-0.0.80/orso/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-14 21:15:26.826980 orso-0.0.80/orso/bitarray/
--rw-r--r--   0 runner    (1001) docker     (123)       32 2023-07-14 21:15:05.000000 orso-0.0.80/orso/bitarray/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)   197298 2023-07-14 21:15:05.000000 orso-0.0.80/orso/bitarray/cbitarray.c
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-14 21:15:26.830980 orso-0.0.80/orso/cityhash/
--rw-r--r--   0 runner    (1001) docker     (123)       66 2023-07-14 21:15:05.000000 orso-0.0.80/orso/cityhash/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)    19319 2023-07-14 21:15:05.000000 orso-0.0.80/orso/cityhash/city.cc
--rw-r--r--   0 runner    (1001) docker     (123)   237362 2023-07-14 21:15:05.000000 orso-0.0.80/orso/cityhash/cityhash.cpp
--rw-r--r--   0 runner    (1001) docker     (123)     3809 2023-07-14 21:15:05.000000 orso-0.0.80/orso/converters.py
--rw-r--r--   0 runner    (1001) docker     (123)    11660 2023-07-14 21:15:05.000000 orso-0.0.80/orso/dataframe.py
--rw-r--r--   0 runner    (1001) docker     (123)    14501 2023-07-14 21:15:05.000000 orso-0.0.80/orso/display.py
--rw-r--r--   0 runner    (1001) docker     (123)     1549 2023-07-14 21:15:05.000000 orso-0.0.80/orso/exceptions.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-14 21:15:26.830980 orso-0.0.80/orso/filters/
--rw-r--r--   0 runner    (1001) docker     (123)       78 2023-07-14 21:15:05.000000 orso-0.0.80/orso/filters/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     4454 2023-07-14 21:15:05.000000 orso-0.0.80/orso/filters/bloom_filter.py
--rw-r--r--   0 runner    (1001) docker     (123)     3457 2023-07-14 21:15:05.000000 orso-0.0.80/orso/filters/cuckoo_filter.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-14 21:15:26.830980 orso-0.0.80/orso/logging/
--rw-r--r--   0 runner    (1001) docker     (123)      142 2023-07-14 21:15:05.000000 orso-0.0.80/orso/logging/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     2922 2023-07-14 21:15:05.000000 orso-0.0.80/orso/logging/add_level.py
--rw-r--r--   0 runner    (1001) docker     (123)     1944 2023-07-14 21:15:05.000000 orso-0.0.80/orso/logging/create_logger.py
--rw-r--r--   0 runner    (1001) docker     (123)     4785 2023-07-14 21:15:05.000000 orso-0.0.80/orso/logging/google_cloud_logger.py
--rw-r--r--   0 runner    (1001) docker     (123)     1445 2023-07-14 21:15:05.000000 orso-0.0.80/orso/logging/levels.py
--rw-r--r--   0 runner    (1001) docker     (123)     4535 2023-07-14 21:15:05.000000 orso-0.0.80/orso/logging/log_formatter.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-14 21:15:26.830980 orso-0.0.80/orso/profiler/
--rw-r--r--   0 runner    (1001) docker     (123)       71 2023-07-14 21:15:05.000000 orso-0.0.80/orso/profiler/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-14 21:15:26.830980 orso-0.0.80/orso/profiler/distogram/
--rw-r--r--   0 runner    (1001) docker     (123)    15497 2023-07-14 21:15:05.000000 orso-0.0.80/orso/profiler/distogram/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     9028 2023-07-14 21:15:05.000000 orso-0.0.80/orso/profiler/profiler.py
--rw-r--r--   0 runner    (1001) docker     (123)     4119 2023-07-14 21:15:05.000000 orso-0.0.80/orso/row.py
--rw-r--r--   0 runner    (1001) docker     (123)     8167 2023-07-14 21:15:05.000000 orso-0.0.80/orso/schema.py
--rw-r--r--   0 runner    (1001) docker     (123)    10662 2023-07-14 21:15:05.000000 orso-0.0.80/orso/tools.py
--rw-r--r--   0 runner    (1001) docker     (123)     1830 2023-07-14 21:15:05.000000 orso-0.0.80/orso/types.py
--rw-r--r--   0 runner    (1001) docker     (123)      601 2023-07-14 21:15:05.000000 orso-0.0.80/orso/version.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-14 21:15:26.826980 orso-0.0.80/orso.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     2007 2023-07-14 21:15:26.000000 orso-0.0.80/orso.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     1180 2023-07-14 21:15:26.000000 orso-0.0.80/orso.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-14 21:15:26.000000 orso-0.0.80/orso.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       23 2023-07-14 21:15:26.000000 orso-0.0.80/orso.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)        5 2023-07-14 21:15:26.000000 orso-0.0.80/orso.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)      237 2023-07-14 21:15:05.000000 orso-0.0.80/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-07-14 21:15:26.834981 orso-0.0.80/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1330 2023-07-14 21:15:05.000000 orso-0.0.80/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-14 21:15:26.834981 orso-0.0.80/tests/
--rw-r--r--   0 runner    (1001) docker     (123)     1066 2023-07-14 21:15:05.000000 orso-0.0.80/tests/test_bitarray.py
--rw-r--r--   0 runner    (1001) docker     (123)      952 2023-07-14 21:15:05.000000 orso-0.0.80/tests/test_cityhash.py
--rw-r--r--   0 runner    (1001) docker     (123)     4625 2023-07-14 21:15:05.000000 orso-0.0.80/tests/test_converters_arrow.py
--rw-r--r--   0 runner    (1001) docker     (123)      565 2023-07-14 21:15:05.000000 orso-0.0.80/tests/test_converters_pandas.py
--rw-r--r--   0 runner    (1001) docker     (123)      565 2023-07-14 21:15:05.000000 orso-0.0.80/tests/test_converters_polars.py
--rw-r--r--   0 runner    (1001) docker     (123)     6941 2023-07-14 21:15:05.000000 orso-0.0.80/tests/test_dataframe.py
--rw-r--r--   0 runner    (1001) docker     (123)     2131 2023-07-14 21:15:05.000000 orso-0.0.80/tests/test_fetching.py
--rw-r--r--   0 runner    (1001) docker     (123)     2173 2023-07-14 21:15:05.000000 orso-0.0.80/tests/test_filter_bloom_filter.py
--rw-r--r--   0 runner    (1001) docker     (123)     1344 2023-07-14 21:15:05.000000 orso-0.0.80/tests/test_filter_cuckoo_filter.py
--rw-r--r--   0 runner    (1001) docker     (123)      950 2023-07-14 21:15:05.000000 orso-0.0.80/tests/test_profiler.py
--rw-r--r--   0 runner    (1001) docker     (123)      691 2023-07-14 21:15:05.000000 orso-0.0.80/tests/test_random.py
--rw-r--r--   0 runner    (1001) docker     (123)     3052 2023-07-14 21:15:05.000000 orso-0.0.80/tests/test_schema.py
--rw-r--r--   0 runner    (1001) docker     (123)     3346 2023-07-14 21:15:05.000000 orso-0.0.80/tests/test_schema_columns.py
--rw-r--r--   0 runner    (1001) docker     (123)     1375 2023-07-14 21:15:05.000000 orso-0.0.80/tests/test_types.py
...
### Comparing `orso-0.0.80/LICENSE` & `orso-0.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `orso-0.0.80/PKG-INFO` & `orso-0.0.9/PKG-INFO`
...
### Comparing `orso-0.0.80/README.md` & `orso-0.0.9/README.md`
...
### Comparing `orso-0.0.80/orso/converters.py` & `orso-0.0.9/orso/converters.py`
...
### Comparing `orso-0.0.80/orso/version.py` & `orso-0.0.9/orso/version.py`
...
### Comparing `orso-0.0.80/orso.egg-info/PKG-INFO` & `orso-0.0.9/orso.egg-info/PKG-INFO`
...
### Comparing `orso-0.0.80/setup.py` & `orso-0.0.9/setup.py`
...
### Comparing `orso-0.0.80/tests/test_fetching.py` & `orso-0.0.9/tests/test_fetching.py`
