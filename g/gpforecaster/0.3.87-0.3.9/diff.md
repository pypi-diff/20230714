# Comparing `tmp/gpforecaster-0.3.87.tar.gz` & `tmp/gpforecaster-0.3.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "gpforecaster-0.3.87.tar", last modified: Fri Jul 14 08:30:15 2023, max compression
+gzip compressed data, was "gpforecaster-0.3.9.tar", last modified: Thu Dec 22 10:07:29 2022, max compression
```

## Comparing `gpforecaster-0.3.87.tar` & `gpforecaster-0.3.9.tar`

### file list

```diff
@@ -1,43 +1,31 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-14 08:30:15.952575 gpforecaster-0.3.87/
--rw-r--r--   0 runner    (1001) docker     (123)     1517 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/LICENCE
--rw-r--r--   0 runner    (1001) docker     (123)      776 2023-07-14 08:30:15.952575 gpforecaster-0.3.87/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     3624 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-14 08:30:15.948575 gpforecaster-0.3.87/gpforecaster/
--rw-r--r--   0 runner    (1001) docker     (123)      387 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-14 08:30:15.952575 gpforecaster-0.3.87/gpforecaster/model/
--rw-r--r--   0 runner    (1001) docker     (123)      104 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/model/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     2719 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/model/gp.py
--rw-r--r--   0 runner    (1001) docker     (123)    38075 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/model/gpf.py
--rw-r--r--   0 runner    (1001) docker     (123)     5951 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/model/hyperparameter_tuning.py
--rw-r--r--   0 runner    (1001) docker     (123)     1905 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/model/mean_functions.py
--rw-r--r--   0 runner    (1001) docker     (123)     1485 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/model/mlls.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-14 08:30:15.952575 gpforecaster-0.3.87/gpforecaster/results/
--rw-r--r--   0 runner    (1001) docker     (123)       33 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/results/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     8239 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/results/calculate_metrics.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-14 08:30:15.952575 gpforecaster-0.3.87/gpforecaster/tests/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/tests/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     1142 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/tests/test_calculate_results.py
--rw-r--r--   0 runner    (1001) docker     (123)      589 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/tests/test_early_stopping.py
--rw-r--r--   0 runner    (1001) docker     (123)      711 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/tests/test_hyperparameter_tuning.py
--rw-r--r--   0 runner    (1001) docker     (123)      659 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/tests/test_model_results_police.py
--rw-r--r--   0 runner    (1001) docker     (123)     1979 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/tests/test_model_results_prison.py
--rw-r--r--   0 runner    (1001) docker     (123)     1491 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/tests/test_results_partial_data.py
--rw-r--r--   0 runner    (1001) docker     (123)     1351 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/tests/test_run_model_with_sampled_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)     1348 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/tests/test_sparse_gps.py
--rw-r--r--   0 runner    (1001) docker     (123)     2778 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/tests/test_store_results.py
--rw-r--r--   0 runner    (1001) docker     (123)     1421 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/tests/test_svg_gps.py
--rw-r--r--   0 runner    (1001) docker     (123)     1588 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/tests/test_tourism_gpf_with_local_file.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-14 08:30:15.952575 gpforecaster-0.3.87/gpforecaster/utils/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/utils/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     1138 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/utils/logger.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-14 08:30:15.952575 gpforecaster-0.3.87/gpforecaster/visualization/
--rw-r--r--   0 runner    (1001) docker     (123)       31 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/visualization/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     2304 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/gpforecaster/visualization/plot_predictions.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-14 08:30:15.948575 gpforecaster-0.3.87/gpforecaster.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)      776 2023-07-14 08:30:15.000000 gpforecaster-0.3.87/gpforecaster.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     1179 2023-07-14 08:30:15.000000 gpforecaster-0.3.87/gpforecaster.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-14 08:30:15.000000 gpforecaster-0.3.87/gpforecaster.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)      181 2023-07-14 08:30:15.000000 gpforecaster-0.3.87/gpforecaster.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       13 2023-07-14 08:30:15.000000 gpforecaster-0.3.87/gpforecaster.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-07-14 08:30:15.952575 gpforecaster-0.3.87/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1630 2023-07-14 08:29:59.000000 gpforecaster-0.3.87/setup.py
...
### Comparing `gpforecaster-0.3.87/PKG-INFO` & `gpforecaster-0.3.9/PKG-INFO`
...
### Comparing `gpforecaster-0.3.87/gpforecaster/tests/test_early_stopping.py` & `gpforecaster-0.3.9/gpforecaster/tests/test_calculate_results.py`
...
### Comparing `gpforecaster-0.3.87/gpforecaster/tests/test_model_results_police.py` & `gpforecaster-0.3.9/gpforecaster/tests/test_model_results_police.py`
...
### Comparing `gpforecaster-0.3.87/gpforecaster/tests/test_model_results_prison.py` & `gpforecaster-0.3.9/gpforecaster/tests/test_early_stopping.py`
...
### Comparing `gpforecaster-0.3.87/gpforecaster/tests/test_tourism_gpf_with_local_file.py` & `gpforecaster-0.3.9/gpforecaster/tests/test_tourism_gpf_with_local_file.py`
...
### Comparing `gpforecaster-0.3.87/gpforecaster.egg-info/PKG-INFO` & `gpforecaster-0.3.9/gpforecaster.egg-info/PKG-INFO`
...
### Comparing `gpforecaster-0.3.87/gpforecaster.egg-info/SOURCES.txt` & `gpforecaster-0.3.9/gpforecaster.egg-info/SOURCES.txt`
...
### Comparing `gpforecaster-0.3.87/setup.py` & `gpforecaster-0.3.9/setup.py`
