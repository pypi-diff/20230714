# Comparing `tmp/trycortex-1.0.5.tar.gz` & `tmp/trycortex-1.0.6.tar.gz`
...
## Comparing `trycortex-1.0.5.tar` & `trycortex-1.0.6.tar`
...
### Comparing `trycortex-1.0.5/trycortex/api.py` & `trycortex-1.0.6/trycortex/api.py`
